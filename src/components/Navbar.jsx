...
const Navbar = () => {
    ...
    return (
        <>
            <nav className='mb-20 flex items-center justify-between py-4 fixed top-0 left-0 right-0 z-50 backdrop-blur-md bg-neutral-950/60 border-b border-neutral-800/50 w-full px-8'>
